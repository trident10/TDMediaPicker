...
class Theme2: ThemeConfig{
    ...
    override func getPermissionScreenConfig() -> TDConfigPermissionScreen {
        ...
        permissionConfig.caption = TDConfigLabel.init(backgroundColor: .clear, textConfig: TDConfigText.init(text: "Allow TDMedia Picker to access your photos.", textColor: .black, textFont: UIFont.init(name: "Arial", size: 22)), textAlignment: .center, lineBreakMode: .byWordWrapping, minimumFontSize: 2.0)
